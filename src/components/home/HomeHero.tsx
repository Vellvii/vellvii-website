    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <motion.img
          ...
          alt="Vellvii"
          className="h-16 md:h-24 mx-auto mb-8 drop-shadow-[0_0_30px_rgba(212,175,55,0.5)]"
        />
        ...
        <motion.h1
          ...
          className="font-baskerville text-4xl md:text-6xl lg:text-7xl text-white mb-4"
        >
          The Art of 'O'
        </motion.h1>
        ...
        <motion.p
          ...
          className="font-montserrat text-lg md:text-xl text-light-secondary mb-12 tracking-wide"
        >
        ...
        >
          <Button
            ...
            size="lg"
            className="bg-primary text-black hover:bg-primary/90 font-montserrat font-semibold tracking-wide px-8 py-6 text-base shadow-elegant hover:shadow-glow transition-all duration-500"
          >
            Explore DOX
          </Button>
          <Link to="/shop">
