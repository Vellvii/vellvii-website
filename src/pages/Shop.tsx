...
const ProductCard = ({ product }: { product: ShopifyProduct }) => {
  ...
  return (
    <Link to={`/product/${product.node.handle}`}>
      <Card className="glass-luxury apple-hover p-4 sm:p-6 text-center group h-full flex flex-col">
        <div className="aspect-square mb-4 overflow-hidden rounded-lg bg-black/20">
          {image ? (
            <img 
              src={image.url} 
...
const ProductSkeleton = () => (
  <Card className="glass-luxury p-4 sm:p-6">
        ...
        <div className="max-w-7xl mx-auto px-4 pb-24">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <p className="text-white/60 text-lg">Failed to load products. Please try again later.</p>
            </div>
