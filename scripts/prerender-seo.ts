...
const routes: RouteSeo[] = [
  ...
  { path: "/products/vellvii-lux", title: "Vellvii Lux | Biometric Sex Toy Storage Bag - Leather, Fingerprint Lock", description: "A genuine leather biometric sex toy storage bag with fingerprint lock and USB charging. Portable, discreet, and available now." },
